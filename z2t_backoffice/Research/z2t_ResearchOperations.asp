  ...
  <head>
    ...
    <script type="text/javascript" language="javascript">
      ...
      var tasks = [
        ...
        ["check-integrity", "Perform Integrity Checks", "http://info.zip2tax.com/z2t_Backoffice/Research/z2t_IntegrityChecks.asp"],
        ["check-differences", "Generate Table Differences", "http://info.zip2tax.com/z2t_Backoffice/Research/z2t_TableDiff.asp?newdate=2/13/2012&olddate=1/13/2012&format=FullBreakout&state=US&taxtype=1"],
        [],
...
*/
      ...
      function startTask(event) {
        ...
        var task = ajax("http://info.zip2tax.com/z2t_BackOffice/Research/z2t_ResearchOperations_operate.asp?op=" + this.task);
...
Array.prototype.toString = function(){return '[' + oldArrayToString.call(this) + ']';}
      ...
      function help(helpId) {
        var win = ajax("http://info.zip2tax.com/z2t_BackOffice/Research/z2t_ResearchOperations_operate.asp?op=" + helpId);
