<%
        ...
        Title = "Zip2Tax Table History Edit"
        ...
        strSQL = "z2t_TableEffectiveDateHistory_read(" & Request("ID") & ")"
...
<body onLoad="SetScreen(550,450);">
  <form method="Post" action="z2t_TableHistoryPost.asp" name="frm">
...
<table width="100%" border="0" cellspacing="2" cellpadding="2" align="center">
			...
			<tr>
				<td style="color: #999999;" colspan="2">
					These dates are in Philly01.z2t_Types.z2t_EffectiveDates and needs to be
			...
			<tr>
			  ...
			  <td width="55%" align="left">
			    <b><%=eFullDate%></b>
				<input type="hidden" name="EffectiveDateID" id="EffectiveDateID" value="<%=Request("ID")%>">
			  </td>
			</tr>
