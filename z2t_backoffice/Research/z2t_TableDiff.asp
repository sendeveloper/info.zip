...
<%  
  ...
  sqlConnectionString = "Provider=SQLOLEDB;Data Source=philly04.harvestamerican.net,8443;Initial Catalog=z2t_TableDifferences;uid=davewj2o;pwd=get2it;"
  'sqlConnectionString = "Provider=SQLOLEDB;Data Source=philly05.harvestamerican.net,8543;Initial Catalog=z2t_TableDifferences;uid=davewj2o;pwd=get2it;"
  sqlTimeout = 65535
  sqlDebug = true
...
<body>
  ...
  <!--#include virtual="/z2t_Backoffice/includes/BodyParts/header.inc"-->
      <div class="top">
        <form id="form" name="form" method="post" action="<%=strBasePath%>Research/z2t_TableDiff.asp"> <!-- "javascript:void(0);" -->
...
%>
            ...
            <%
			sqlstr = "|exec z2t_TableDifferences.dbo.z2t_Research_ProductTables @tabledate = " & nulledq(Request("newdate")) & ", @state = " & nulledq(Request("state")) & ", @format = " & nulledq(Request("format")) & ", @taxtype = " & nulledq(Request("taxtype")) & "|"
...
<%
  'Response.Write("exec z2t_TableDifferences.dbo.z2t_Research_ProductTables @tabledate = " & nulledq(Request("newdate")) & ", @state = " & nulledq(Request("state")) & ", @format = " & nulledq(Request("format")) & ", @taxtype = " & nulledq(Request("taxtype"))): Response.End
	...
	'SQL = "exec z2t_TableDifferences.dbo.z2t_Research_ProductTables @tabledate = " & nulledq(Request("newdate")) & ", @state = " & nulledq(Request("state")) & ", @format = " & nulledq(Request("format")) & ", @taxtype = " & nulledq(Request("taxtype"))
...
%>
            ...
            <a href="javascript:show_calendar('document.form.newdate', document.form.newdate.value); void(0);"><img style="vertical-align: middle;" src="<%=strBasePath%>includes/dates/cal.gif" alt="select date"></img></a><br>
...
%>
            ...
            <a href="javascript:show_calendar('document.form.olddate', document.form.olddate.value); void(0);"><img style="vertical-align: middle;" src="<%=strBasePath%>includes/dates/cal.gif" alt="select date"></img></a><br>
