<html>
<head>
    <title>State Information Shipping Taxable</title>
</head>
...
<%	 Dim efilterby
	...
	strSQL = "z2t_StateInfo_ShippingTaxable_update('" & request("state") & "','" & trim(request("sShippingTaxable")) & "','" & Session("z2t_login") &"')"
