<%
        ...
        Title = "Edit Liquor Tax Per Gallon for "
        ...
        strSQL = "z2t_StateInfo_Alcohal_read('" & request("state") & "',3)"
		
        rs.open strSQL, connPhilly05, 3, 3, 4

		If not rs.eof Then
			eLiquorTaxPerGallon = rs("TaxPerGallon")			
...
<body onLoad="SetScreen(660,330);">
  ...
  <form method="Post" action="z2t_StateInformationLiquorTaxPerGallon_Post.asp" name="frm">
	 ...
	 <table width="100%" border="0" cellspacing="2" cellpadding="2" align="center">
				...
				<td style="color: #999999;" colspan="2">
					This indicates the tax amount per gallon of liquor. 
				</td>		 
			</tr>	
            <tr><td>&nbsp;</td></tr>
			<tr>
			  <td width="55%" align="center">
                 Tax Per Gallon:  <input type="text" id="LiquorTaxPerGallon" name="LiquorTaxPerGallon" 
                  	class="LiquorTaxPerGallon"  value="<%=eLiquorTaxPerGallon%>"/>
