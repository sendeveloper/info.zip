<%
        ...
        Response.clear
		Title = "Edit used automobile tax rates for "
...
<body onLoad="SetScreen(900,500);">
  <form method="Post" action="z2t_StateInformationUsed_post.asp" name="frm">
	 ...
	 <table width="100%" border="0" cellspacing="2" cellpadding="2" align="center">
			<tr><td>&nbsp;</td></tr>		
				...
				<td style="color: #999999;" colspan="2">
		            This indicates sales tax rate for used automobiles.
				</td>		 
			</tr>	
            <tr><td>&nbsp;</td></tr>
			...
			<tr>
              ...
              <textarea cols="1" rows="1" id="Used" name="Used" class="Used"><%=eUsed%>
              </textarea>
         	  </td>
			</tr>
