<%
        ...
        Title = "Edit Initial Checked for "
		...
		If not rs.eof Then
			eCheckedDateInitial = rs("CheckedDateInitial")
			eStateName = rs("Name")
...
<body onLoad="SetScreen(550,450);">
  ...
  <form method="Post" action="z2t_StateInformationInitialChecked_post.asp" name="frm">
	 ...
	 <table width="100%" border="0" cellspacing="2" cellpadding="2" align="center">
			...
			<tr>
				<td style="color: #999999;" colspan="2">
					This date indicates when the State has been checked most recently for tax related changes.
			...
			<tr>
			  ...
			  <td width="55%" align="left">
				<input class="field date" type="date" size="20" name="InitialChecked" id="InitialChecked"
                  value="<%=eCheckedDateInitial%>">
			  </td>
			</tr>
