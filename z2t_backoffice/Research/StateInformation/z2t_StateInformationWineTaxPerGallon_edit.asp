<%
        ...
        Title = "Edit Wine Tax Per Gallon for "
		...
		If not rs.eof Then
			eWineTaxPerGallon = rs("TaxPerGallon")			
...
<body onLoad="SetScreen(660,330);">
  <form method="Post" action="z2t_StateInformationWineTaxPerGallon_post.asp" name="frm">
	 ...
	 <table width="100%" border="0" cellspacing="2" cellpadding="2" align="center">
			...
			<tr>
			  <td width="55%" align="center">
                Tax Per Gallon:   <input type="text" id="WineTaxPerGallon" name="WineTaxPerGallon" 
                  	class="WineTaxPerGallon"  value="<%=eWineTaxPerGallon%>"/>
         	  </td>
			</tr>
