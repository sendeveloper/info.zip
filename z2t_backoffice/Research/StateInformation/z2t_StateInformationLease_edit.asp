<%
        ...
        Title = "Edit automible lease tax rates for "
...
<body onLoad="SetScreen(900,500);">
  ...
  <form method="Post" action="z2t_StateInformationLease_post.asp" name="frm">
	 ...
	 <table width="100%" border="0" cellspacing="2" cellpadding="2" align="center">
				...
				<td style="color: #999999;" colspan="2">
					This indicates sales tax rate for Lease automobiles.   
				</td>		 
			</tr>	
            <tr><td>&nbsp;</td></tr>
			<tr>
			  <td width="55%" align="left">
              <textarea cols="1" rows="1" id="Lease" name="Lease" class="Lease"><%=eLease%>
              </textarea>
         	  </td>
			</tr>
