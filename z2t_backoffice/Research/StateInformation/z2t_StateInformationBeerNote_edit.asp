...
<body onLoad="SetScreen(900,500);">
  <form method="Post" action="z2t_StateInformationBeerNote_post.asp" name="frm">
	 ...
	 <table width="100%" border="0" cellspacing="2" cellpadding="2" align="center">
				...
				<td style="color: #999999;" colspan="2">
					This indicates notes regarding sales tax on beer.
				</td>		 
			</tr>	
            <tr><td>&nbsp;</td></tr>
			<tr>
			  <td width="55%" align="left">
              <textarea cols="1" rows="1" id="BeerNote" name="BeerNote" class="BeerNote"><%=eBeerNote%>
              </textarea>
         	  </td>
			</tr>
