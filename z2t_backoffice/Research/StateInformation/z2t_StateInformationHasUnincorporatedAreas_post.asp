<html>
<head>
    <title>State Information Has Unincorporated Areas Post</title>
</head>
...
<%	 Dim efilterby
	...
	strSQL = "z2t_StateInfo_HasUnincorporatedAreas_update('" & request("state") &_
	 "','" & request("hUniCorp") & "','" & Session("z2t_login") &"')"
