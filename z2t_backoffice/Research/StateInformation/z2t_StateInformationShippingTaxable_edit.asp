<%
		...
		If not rs.eof Then
			eShippingTaxable = rs("ShippingTaxable")
			eStateName = rs("Name")
...
<body onLoad="SetScreen(550,450);">
  ...
  <form method="Post" action="z2t_StateInformationShippingTaxable_post.asp" name="frm">
	 ...
	 <table width="100%" border="0" cellspacing="2" cellpadding="2" align="center">
			...
			<tr>
				<td style="color: #999999;" colspan="2">
					This indicates Yes if shipping charges are generally taxable for the particular state. No if shipping charges are generally not taxable.                    
				</td>		 
			</tr>
