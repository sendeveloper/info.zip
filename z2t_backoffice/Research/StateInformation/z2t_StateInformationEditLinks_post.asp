<html>
<head>
    <title>State Information Links Post</title>
</head>
...
<%	 Dim efilterby
	...
	strSQL = "z2t_StateInfo_EditLinks_update('" & request("state") & "','" & request("StateDataPageLink") & "','" & request("HomePageLink") & "','" & Session("z2t_login") &"')"
