...
<body onLoad="SetScreen(550,450);">
  ...
  <form method="Post" action="z2t_StateInformationSourcing_post.asp" name="frm">
	 ...
	 <table width="100%" border="0" cellspacing="2" cellpadding="2" align="center">
			...
			<tr>
				<td style="color: #999999;" colspan="2">
					This indicates whether a state follows origin-based sourcing or destination-based sourcing for general sales.                   
				</td>		 
			</tr>
