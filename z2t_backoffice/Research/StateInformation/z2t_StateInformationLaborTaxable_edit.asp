...
<body onLoad="SetScreen(550,450);">
  ...
  <form method="Post" action="z2t_StateInformationLaborTaxable_post.asp" name="frm">
	 ...
	 <table width="100%" border="0" cellspacing="2" cellpadding="2" align="center">
			...
			<tr>
				<td style="color: #999999;" colspan="2">
					This indicates Yes if labor charges are generally taxable for the particular state. No if labor charges are enerally not taxable.                    
				</td>		 
			</tr>
