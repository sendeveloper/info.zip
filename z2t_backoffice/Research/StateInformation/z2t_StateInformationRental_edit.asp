<%
        ...
        Title = "Edit automible rental tax rates for "
...
<body onLoad="SetScreen(900,500);">
  <form method="Post" action="z2t_StateInformationRental_post.asp" name="frm">
 			...
 			<tr><td>&nbsp;</td></tr>	
           	<tr>
				<td style="color: #999999;" colspan="2">
					This indicates sales tax rate for Rental automobiles.  
				</td>		 
			</tr>	
            <tr><td>&nbsp;</td></tr>
			<tr>
			  <td width="55%" align="left">
              <textarea cols="1" rows="1" id="Rental" name="Rental" class="Rental"><%=eRental%>
              </textarea>
         	  </td>
			</tr>
