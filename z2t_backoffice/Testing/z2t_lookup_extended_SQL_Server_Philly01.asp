...
<body>
    <h4><center>Z2t_lookup_extended Call</center></h4>
...
rs.open "z2t_link.z2t_lookup_extended('" & strZipCode & "', '" & strUsername & "', '" & strPassword & "')", conn, 3, 3, 4
...
If not rs.EOF then
    ...
    Response.write "Sales Tax Reporting Code Special: " & rs("Sales_Tax_Reporting_Code_Special") & "<br />"
End If
